...
- **Макросы**: 
- **Alt Blocker**: Блокировка меню окна при нажатии Alt (предотвращает потерю фокуса).
- **CRM Авто-вход**: Автоматическая авторизация в CRM (поддержка Chrome, Edge, Yandex).
